import{j as e,o as t,i as a}from"../chunks/chunk-st3qvgMA.js";import{L as i}from"../chunks/chunk-BMhWa9xj.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-3ulBLjzN.js";/* empty css                      */const o=[{pageSectionId:"example",pageSectionLevel:2,pageSectionTitle:"Example"},{pageSectionId:"naming-convention",pageSectionLevel:2,pageSectionTitle:"Naming convention"},{pageSectionId:"exceptions",pageSectionLevel:2,pageSectionTitle:"Exceptions"}];function l(s){const n={blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"With REST/GraphQL, API endpoints are:"}),`
...
`,e.jsxs(n.p,{children:["Telefunc displays a warning whenever the naming convention isn't followed. You can remove the warning with ",e.jsx(i,{text:e.jsx(n.code,{children:"config.disableNamingConvention"}),href:"/disableNamingConvention"}),"."]}),`
